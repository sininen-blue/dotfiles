...
awful.spawn("xset r 66")
awful.spawn('xinput set-prop 12 "libinput Tapping Enabled" 1')
awful.spawn.single_instance("gammastep -l 8.9475:125.5406")
...
beautiful.init(gears.filesystem.get_dir("config") .. "/themes/catppuccin_mocha/theme.lua")
